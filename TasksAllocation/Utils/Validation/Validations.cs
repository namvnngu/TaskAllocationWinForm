...
namespace TasksAllocation.Utils.Validation
{
    class Validations
    {
        public static bool CheckExtension(string filePath, string expectedExtension, ref ErrorManager errorManager, string fileName, string lineNumber)
        {
        ...
        public static bool CheckProcessedFileExists(string filename, string expectedFilename, ref ErrorManager errorManager, string fileName)
        {
            if (filename == null)
            {
        ...
        public static string[] CheckPairKeyValue(string line, string key, string value, ref ErrorManager errorManager, string fileName, string lineNumber)
        {
        ...
        public static string CheckTextValueExist(string text, string actualValue, string expectedValue, ref ErrorManager errorManager, string fileName, string lineNumber)
        {
        ...
        public static bool CheckInvalidFileNameChars(string filePath, ref ErrorManager errorManager, string fileName, string lineNumber)
        {
        ...
        public static bool CheckFileExists(string filePath, ref ErrorManager errorManager, string fileName, string lineNumber)
        {
